...
test.describe('Screen Navigation Test - All 12 Screens', () => {
  ...
  async function captureScreen(
    ...
    try {
      ...
      result.mockDataLoaded = !bodyText?.includes('No data') && !bodyText?.includes('No appointments');
  ...
  test('2. Complete Onboarding - Click Get Started or Login', async () => {
    ...
    try {
      const getStartedButton = page.locator('button:has-text("Get Started"), a:has-text("Get Started"), ion-button:has-text("Get Started")').first();
      ...
      // Try login button
      try {
        const loginButton = page.locator('button:has-text("Login"), a:has-text("Login"), ion-button:has-text("Login"), [routerLink="/login"]').first();
  ...
  test('8. Settings Page', async () => {
    ...
    try {
      const settingsButton = page.locator('ion-button:has-text("Settings"), button:has-text("Settings"), [routerLink="/settings"]').first();
  ...
  test('9. Advanced Settings', async () => {
    ...
    try {
      const advancedButton = page.locator('ion-item:has-text("Advanced"), [routerLink*="advanced"]').first();
  ...
  test('10. Add Reading Page', async () => {
    ...
    try {
      const addButton = page.locator('ion-fab-button, [routerLink*="add-reading"], button:has-text("Add")').first();
  ...
  test('11. Dashboard Detail', async () => {
    ...
    try {
      const detailButton = page.locator('ion-button:has-text("Detail"), ion-button:has-text("View"), [routerLink*="dashboard-detail"]').first();
